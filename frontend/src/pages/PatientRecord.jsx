                    ...
                    <table className="w-full text-xs">
                      <thead>
                        <tr className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-widest border-b border-[var(--border)]">
                          ...
                          <th className="text-center px-2 py-2">Copiar</th>
                          <th className="text-center px-2 py-2">Enviar</th>
                              ...
                              {(() => {
                                ...
                                return (
                                  <a
                                    ...
                                    className="p-1.5 rounded-lg text-[#25D366] hover:bg-[#25D366]/10 transition-colors inline-block"
