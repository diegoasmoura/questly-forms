    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <section className="text-center py-20 lg:py-32 px-8">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 border border-brand-100 mb-8">
            ...
            <span className="text-sm font-medium text-brand-700">Para profissionais de saúde mental</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-slate-900 leading-tight mb-6 tracking-tight">
            ...
            <br />
            <span className="text-brand-700">com precisão</span>
          </h1>
      ...
      <footer className="py-8 px-8 border-t border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded flex items-center justify-center bg-brand-700">
