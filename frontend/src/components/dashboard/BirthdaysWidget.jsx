...
export function BirthdaysWidget({ upcomingBirthdays }) {
  return (
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[20px] p-5 flex flex-col h-full min-h-0">
      ...
      {upcomingBirthdays.length === 0 ? (
        ...
        <div className="flex flex-col gap-2.5 overflow-y-auto custom-scrollbar flex-1 min-h-0 pr-1">
